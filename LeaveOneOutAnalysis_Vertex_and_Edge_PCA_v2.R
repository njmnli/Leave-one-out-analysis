...
setwd("C:/Users/Nirjal/Documents/LOOA_SY5Y_v2/")
directory <- getwd()
directory
...
for (i in 1:length(OG_vertex_list)) {
  ...
  #mod_edge_graph <- delete_edges(input_graph, edge_list[i])
  
  
  #ClustCoeff_scores <- transitivity(input_graph, type = "local", vids = NULL, weights = NULL, isolates = c("NaN", "zero"))
  # Transitivity - measures the probability that the adjacent vertices of a vertex are connected.
  #   This is sometimes also called the Clustering Coefficient.
  #ClustCoeff_graph_score <- transitivity(input_graph, type = "global", vids = NULL, weights = NULL, isolates = c("NaN", "zero"))
  # Transitivity - measures the probability that the adjacent vertices of a vertex are connected.
  #   This is sometimes also called the Clustering Coefficient.
  ...
  # incorrectly used input_graph in v5!!!
  #  EigenCentr_score
  #  DegreeCentr_score
  #  BetweennessCentr_score
  #  ClosenessCentr_score
...
#abline(h = cutoff_point, lty = 2, col = "blue")
#text(4.8, 1.1, "Cutoff point for selecting no. of components", cex = 0.5, font = 2)
dev.off()

#Choose all components that eigenvalue greater than or equal to 1, and do a sum of those components to find final influence value
